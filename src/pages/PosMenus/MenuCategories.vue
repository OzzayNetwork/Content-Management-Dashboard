  ...
  <div class="row">
    <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0 font-size-18">Menu Categories</h4>
        <div class="page-title-right">
          <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item">
              <a href="javascript: void(0);">Menu Items</a>
            </li>
      ...
      <div class="col-12 col-md-6 col-lg-5 col-xl-4">
        ...
        <div class="card">
          <div class="card-body p-5 text-center">
            <div class="mb-5 mt-3">
              <img src="../../assets/images/empty-menu-category.svg" alt="No Menu Categories" class="img-fluid"
                style="max-width: 150px; height: auto;" />
            </div>

            <h3 class="text-black fw-bold mb-4 text-capitalize text fs-2">
            ...
            <p class="text-muted mb-4 fs-6 mx-auto text-black" style="max-width: 400px">
              ...
              Categories help organize your products and make checkout faster
              for your staff. Examples: <i><b class="">"Beverages", "Main Courses",
                  "Appetizers", "Desserts"</b></i>.
            </p>
            ...
            <!-- Secondary helpful info -->
            <div class="mt-4 pt-3 border-top">
              <p class="text-muted text mb-0 pb-0">
                <i class="fas fa-lightbulb me-1 text-warning "></i>
                Tip: You can always add, edit, or delete categories later
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="mt-1 opacity-25">
          <img src="../../assets/images/favicon.svg" alt="No Menu Categories" class="img-fluid"
...
import TableTestVue from './TableTest.vue';
import TestDataTableVue from './testDataTable.vue';
